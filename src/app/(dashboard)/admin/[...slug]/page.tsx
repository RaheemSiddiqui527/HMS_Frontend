  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 items-center justify-center p-8">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-slate-500 mb-6 font-medium">This section of the admin panel is currently under construction and has not been fully implemented in the frontend yet.</p>
      </div>
    </div>
  );
}
